# Quick GitHub Copilot Hackday

A self-contained **20-minute GitHub Copilot workshop** focused on **Agent mode**, **Plan mode**, and **Agent Skills**, plus the customization files (`copilot-instructions.md`, `*.instructions.md`, `*.prompt.md`, `SKILL.md`) that steer GitHub Copilot toward your team's standards.

The repo doubles as a working example: the customization files in [.github/](.github/) are real and active when you open this folder in VS Code with the GitHub Copilot Chat extension.
...
| [.github/copilot-instructions.md](.github/copilot-instructions.md) | Repo-wide standards GitHub Copilot inherits on every request |
...
- GitHub Copilot Chat must show the **Ask / Plan / Agent** mode picker.
